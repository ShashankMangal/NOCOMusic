...
import com.sharkBytesLab.nocomusic.Screens.DownloadSongScreen;
...
public class DownloadSongAdapter extends RecyclerView.Adapter<DownloadSongAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        Glide.with(context).load(downloadModel.getImage()).into(holder.imageView);
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                pd.show();
                pd.setContentView(R.layout.progress_dialog_2);
        ...
        holder.cardView.startAnimation(AnimationUtils.loadAnimation(holder.itemView.getContext(), R.anim.anim_1));
