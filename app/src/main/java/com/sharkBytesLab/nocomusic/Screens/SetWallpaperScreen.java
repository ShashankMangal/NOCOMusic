...
import com.sharkBytesLab.nocomusic.databinding.ActivitySetWallpaperScreenBinding;
...
public class SetWallpaperScreen extends AppCompatActivity {
    ...
    public void onBackPressed() {
        ...
        startActivity(new Intent(SetWallpaperScreen.this, WallpaperScreen.class));
        finish();
